//
//  VisitCustomerComplaintViewController.m
//  TestSaleMJ2
//
...
@implementation VisitCustomerComplaintViewController
...
- (void)viewDidLoad
{
    ...
    //Init data
    dicData = [[NSDictionary alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"CustomerComplaint" ofType:@"plist"]];
    
    
    keys = [[NSArray alloc] initWithObjects:@"Customer complaint", @"Photo", nil];
}
    ...
    if ([indexPath section] == 0) {
        ...
        if ([[array objectAtIndex:[indexPath row]] isEqualToString:@"_photo"]) {
            ...
            if (cell == nil) {
                ...
                [[NSBundle mainBundle] loadNibNamed:@"TableCell_CustomerComplaint" owner:self options:nil];
                cell = cellBroweImage;
