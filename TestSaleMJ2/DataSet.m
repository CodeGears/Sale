...
-(NSMutableArray *)getRowsForTableAsArray:(NSString *)tableName
{
	NSInteger i;
	NSMutableArray *returnArray = [[[NSMutableArray alloc] init] autorelease];
	NSMutableDictionary *tbl = [[NSMutableDictionary alloc] initWithDictionary:[self.Tables objectForKey:tableName]];
	NSMutableArray *sortArrayNumbers = [[NSMutableArray alloc] initWithArray:[tbl allKeys]];
	NSSortDescriptor *sortDesc = [[NSSortDescriptor alloc] initWithKey:@"intValue" ascending:YES];
	NSMutableArray *sortedKeys = [NSMutableArray arrayWithArray:[sortArrayNumbers sortedArrayUsingDescriptors:[NSArray arrayWithObject:sortDesc]]];
	
	//loop through array
	for (i=0;i<[sortedKeys count];i++)
	{
		
		//NSLog(@"sortkey %d",[[sortedKeys objectAtIndex:i] intValue], nil);
							 
		NSMutableDictionary *thisRow = (NSMutableDictionary *)[tbl objectForKey:[NSString stringWithFormat:@"%d", [[sortedKeys objectAtIndex:i] intValue], nil]];
		
		[returnArray addObject:thisRow];
		
	}
	[sortArrayNumbers release];
