//
//  VisitMarketSurveyViewController.m
//  TestSaleMJ2
//
...
@implementation VisitMarketSurveyViewController

@synthesize cell4Column,cellHeader;
...
- (void)viewDidLoad
{
    ...
    //Init data
    dicData = [[NSDictionary alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"MarketSurvey" ofType:@"plist"]];
    
    
    keys = [[NSArray alloc] initWithObjects:@"Market survey", nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[array objectAtIndex:[indexPath row]] isEqualToString:@"_Header"]) {
        ...
        if (cell == nil) {
            ...
            [[NSBundle mainBundle] loadNibNamed:@"TableCell_MarketSurvey" owner:self options:nil];
            cell = cellHeader;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    // Navigation logic may go here. Create and push another view controller.
     ...
     MarketSurvQuesViewCTRL *detailViewController = [[MarketSurvQuesViewCTRL alloc] initWithNibName:@"MarketSurvQuesViewCTRL" bundle:nil];
     // ...
