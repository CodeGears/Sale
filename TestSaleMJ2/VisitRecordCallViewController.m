//
//  VisitRecordCallViewController.m
//  TestSaleMJ2
//
...
@implementation VisitRecordCallViewController
...
- (void)viewDidLoad
{
   ...
   // self.navigationItem.rightBarButtonItem = self.editButtonItem;
    ...
    dicData = [[NSDictionary alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"RecordCall" ofType:@"plist"]];
    
       
    keys = [[NSArray alloc] initWithObjects:@"Record call", @"Objective1", @"Objective2", @"Objective3", @"Supervisor", nil];
